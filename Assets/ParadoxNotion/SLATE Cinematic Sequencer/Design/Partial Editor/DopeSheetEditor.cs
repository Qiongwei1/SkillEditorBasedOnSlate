...
namespace Slate
{
    ...
    ///<summary>A DopeSheet editor for animation curves</summary>
    public static class DopeSheetEditor
    {

        ///<summary>Event raised when the DopeSheet changes the current curves, with argument being the IAnimatable the curves belong to.</summary>
        ...
        public class DopeSheetRenderer
        {
            ...
            ///<summary>Context menu for multiple keys</summary>
            ...
            ///<summary>Copy the keyframe at time</summary>
            ...
            ///<summary>Copy selected keys</summary>
            ...
            ///<summary>Delete the keyframe at time</summary>
            ...
            ///<summary>Delete selected keyframe indeces</summary>
            ...
            ///<summary>Paste the previously copied keyframe</summary>
            ...
            ///<summary>Paste previously copied multiple keyframes</summary>
            ...
            ///<summary>Set all selected keys tangent mode</summary>
            ...
            ///<summary>Insert space by moving all keys after forward</summary>
            ...
            ///<summary>Remove space by moving all keys after backwards</summary>
